...
public class PluginManager {
    ...
    public PluginManager() throws IOException {
        ...
        for (String path : pluginFolder.list()) {
            ...
            while (inputStream.ready()) {
                ...
                if (line.startsWith("main") && line.split("=").length > 1)
                    main = line.split("=")[1];
                if (line.startsWith("name") && line.split("=").length > 1)
                    name = line.split("=")[1];
            }
            if (main == null) {
     ...
     * 
     * @param name Name of Plugin to give.
     ...
     * 
     * @param request The request to pass to all Plugins.
     */
     ...
     * 
     * @param client The client to pass to all Plugins.
     */
